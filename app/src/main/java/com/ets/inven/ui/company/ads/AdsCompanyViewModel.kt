...
class AdsCompanyViewModel : ViewModel() {
    ...
    fun loadAds(token: String, type: String?) {
        Api.service.userAds("Bearer $token", type).enqueue(object : Callback<ArrayList<AdPreviewModel>> {
